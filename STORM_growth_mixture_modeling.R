...
lcga1 = readRDS(here("Growth_mixture_models/1_class_model_linear.rds"))
lcga2 = readRDS(here("Growth_mixture_models/2_class_model_linear.rds"))
lcga3 = readRDS(here("Growth_mixture_models/3_class_model_linear.rds"))
lcga4 = readRDS(here("Growth_mixture_models/4_class_model_linear.rds"))
lcga5 = readRDS(here("Growth_mixture_models/5_class_model_linear.rds"))
lcga6 = readRDS(here("Growth_mixture_models/6_class_model_linear.rds"))

gmm1 = readRDS(here("Growth_mixture_models/1_class_model_intercepts_only.rds"))
gmm2 = readRDS(here("Growth_mixture_models/2_class_model_intercepts_only.rds"))
gmm3 = readRDS(here("Growth_mixture_models/3_class_model_intercepts_only.rds"))
gmm4 = readRDS(here("Growth_mixture_models/4_class_model_intercepts_only.rds"))
gmm5 = readRDS(here("Growth_mixture_models/5_class_model_intercepts_only.rds"))
gmm6 = readRDS(here("Growth_mixture_models/6_class_model_intercepts_only.rds"))

gmm1_2 = readRDS(here("Growth_mixture_models/1_class_model_intercepts+slopes.rds"))
gmm2_2 = readRDS(here("Growth_mixture_models/2_class_model_intercepts+slopes.rds"))
gmm3_2 = readRDS(here("Growth_mixture_models/3_class_model_intercepts+slopes.rds"))
gmm4_2 = readRDS(here("Growth_mixture_models/4_class_model_intercepts+slopes.rds"))
gmm5_2 = readRDS(here("Growth_mixture_models/5_class_model_intercepts+slopes.rds"))
gmm6_2 = readRDS(here("Growth_mixture_models/6_class_model_intercepts+slopes.rds"))
